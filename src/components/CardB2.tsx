    ...
    return (
      ...
      >
        ...
        <div style={{ flex: 1, display: 'flex', padding: '0 3mm 2mm', minHeight: 0 }}>
          {/* Informations - utilise overflow hidden pour ne jamais pousser le QR */}
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '0.3mm', overflow: 'hidden', minWidth: 0 }}>
          ...
          {/* QR Code - position fixe, ne bouge jamais */}
          <div style={{ width: '16mm', minWidth: '16mm', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingLeft: '2mm', flexShrink: 0 }}>
            <QRCodeSVG
              value={qrData}
              size={55}
              level="M"
...
// Calcule la taille de police adaptative selon la longueur de la valeur
...
const DataRow = ({ label, value }: { label: string; value: string }) => (
  <div style={{ display: 'flex', alignItems: 'baseline', lineHeight: 1.2, minWidth: 0 }}>
    <span
      style={{
