  ...
  ({ contributor }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* Titre principal */}
        <div style={{ textAlign: 'center', padding: '0.25mm 0', marginTop: '-1.5mm', flexShrink: 0 }}>
          <span
            style={{
              color: 'hsl(354 85% 49%)',
              fontSize: '7pt',
...
const DataRow = ({ label, value }: { label: string; value: string }) => (
  <div style={{ display: 'flex', alignItems: 'baseline', lineHeight: 1.2 }}>
    ...
    <span style={{ fontSize: '5.8pt', fontWeight: 800, marginLeft: '1.5mm' }}>{value && value.trim().length > 0 ? value : '–'}</span>
  </div>
);
